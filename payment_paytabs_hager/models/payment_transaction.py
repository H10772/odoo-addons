...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_rendering_values(self, processing_values):
        ...
        if self.provider_code != 'paytabs_hager':
            return res
    ...
    def _prepare_paytabs_payment_request(self):
        ...
        return {
            ...
            "callback": f"{self.provider_id.get_base_url()}/payment/paytabs_hager/callback",
            "return": f"{self.provider_id.get_base_url()}/payment/paytabs_hager/return?ref={self.reference}",
    ...
    def _get_tx_from_notification_data(self, provider_code, notification_data):
        ...
        if provider_code != 'paytabs_hager' or len(tx) == 1:
            return tx
        ...
        tx = self.search([('reference', '=', reference), ('provider_code', '=', 'paytabs_hager')])
        if not tx:
            raise ValidationError(
